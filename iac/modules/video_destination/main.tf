...
module "sns_event" {
  ...
  s3_bucket_name     = aws_s3_bucket.raw_target.id
  snowflake_iam_user = var.snowflake_iam_user
}

module "video_destination_detail" {
  source                                       = "../video_detail"
  app                                          = var.app
  ...
  loader_role_arn                              = var.east_loader_role_arn
  ecr_loader_arn                               = var.east_ecr_loader_arn
  ecr_loader_ltpd_arn                          = var.east_ecr_loader_ltpd_arn
  ecr_reader_ltpd_arn                          = var.east_ecr_reader_ltpd_arn
...
output "lb_dns" {
  value = module.video_destination_detail.lb_dns
}

output "lb_zone_id" {
  value = module.video_destination_detail.lb_zone_id
}

output "lb_arn" {
  value      = module.video_destination_detail.lb_arn
  depends_on = [module.video_destination_detail.lb_arn]
}

output "lb_arn_suffix" {
  value = module.video_destination_detail.lb_arn_suffix
}

output "lb_tg_arn_suffix" {
  value = module.video_destination_detail.lb_tg_arn_suffix
}

output "ecs_cluster_name" {
  value = module.video_destination_detail.ecs_cluster_name
}

output "ecs_service_name" {
  value = module.video_destination_detail.ecs_service_name
}

output "kinesis_stream_name_raw" {
  value = module.video_destination_detail.kinesis_stream_name_raw
}

output "kinesis_stream_name_late" {
  value = module.video_destination_detail.kinesis_stream_name_late
}

output "kinesis_stream_name_sess" {
  value = module.video_destination_detail.kinesis_stream_name_sess
}

output "kinesis_firehose_name_raw" {
  value = module.video_destination_detail.kinesis_firehose_name_raw
}

output "kda_app_name_agg" {
  value = module.video_destination_detail.kinesis_kda_name_agg
}

output "destination_raw_target_bucket_arn" {
  value = aws_s3_bucket.raw_target.arn
}

output "destination_raw_target_bucket_kms_arn" {
  value = aws_kms_key.raw_s3.arn
}

output "destination_late_target_bucket_arn" {
  value = aws_s3_bucket.late_target.arn
}

output "destination_late_target_bucket_kms_arn" {
  value = aws_kms_key.late_s3.arn
}

output "destination_sess_target_bucket_arn" {
  value = aws_s3_bucket.sess_target.arn
}

output "destination_sess_target_bucket_kms_arn" {
...
output "timestream_db_name" {
  value = module.video_destination_detail.timestream_db_name
}

output "sessions_table_name" {
  value = module.video_destination_detail.sessions_table_name
}

output "timestream_kms_arn" {
  value = module.video_destination_detail.timestream_kms_arn
}

output "cluster_name" {
  value = module.video_destination_detail.cluster_name
}

output "sqs_outbound_url" {

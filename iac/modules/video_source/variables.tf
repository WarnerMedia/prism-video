...
#destination s3 info
variable "destination_raw_target_bucket_arn" {
}

variable "destination_raw_target_bucket_kms_arn" {
}

variable "destination_late_target_bucket_arn" {
}

variable "destination_late_target_bucket_kms_arn" {
}

variable "destination_sess_target_bucket_arn" {
}

variable "destination_sess_target_bucket_kms_arn" {
}
